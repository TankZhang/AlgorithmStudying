...
//12th
void ShellSort12(int nums[], int n)
{
	int gap, i, j, k, temp;
	for (gap = n / 2; gap > 0; gap /= 2)
		for (i = 0; i < gap; i++)
...
//13th
void ShellSort13(int nums[], int n)
{
	int gap, i, j, k, temp;
	for (gap = n / 2; gap > 0; gap /= 2)
		for (i = 0; i < gap; i++)
...
//16th
void ShellSort16(int nums[], int n)
{
	int gap, i, j, k, temp;
	for (gap = n / 2; gap > 0; gap /= 2)
		for (i = 0; i < gap; i++)
...
//17th
void ShellSort17(int nums[], int n)
{
	int gap, i, j, k, temp;
	for (gap = n / 2; gap > 0; gap /= 2)
		for (i = 0; i < gap; i++)
...
//18th
void ShellSort18(int nums[], int n)
{
	int gap, i, j, k, temp;
	for(gap=n/2;gap>0;gap/=2)
		for(i=0;i<gap;i++)
...
//19th
void ShellSort19(int nums[], int n)
{
	int gap, i, j, k, temp;
	for(gap=n/2;gap>0;gap/=2)
		for(i=0;i<gap;i++)
...
//20
void ShellSord20(int nums[], int n)
{
	int gap, i, j, k, temp;
	for(gap=n/2;gap>0;gap/=2)
		for(i=0;i<gap;i++)
