...
//8th
void SelectSort8(int nums[], int n)
{
	int i, j;
	for(i=0;i<n;i++)
		for(j=i+1;j<n;j++)
...
//9th
void SelectSort9(int nums[], int n)
{
	int i, j;
	for(i=0;i<n;i++)
		for(j=i+1;j<n;j++)
...
//10th
void SelectSort10(int nums[], int n)
{
	int i, j;
	for(i=0;i<n;i++)
		for(j=i+1;j<n;j++)
...
//11th
void SelectSort11(int nums[], int n)
{
	int i, j;
	for(i=0;i<n;i++)
		for(j=i;j<n;j++)
...
//12th
void SelectSort12(int nums[], int n)
{
	int i, j;
	for(i=0;i<n;i++)
		for(j=i;j<n;j++)
