...
//10th
void InsertionSort10(int nums[], int n)
{
	int i, j, k, temp;
	for (i = 1; i < n; i++)
	{
...
//11th
void InsertionSort11(int nums[], int n)
{
	int i, j, k, temp;
	for (i = 1; i < n; i++)
	{
...
//13th
void InsertionSort13(int nums[], int n)
{
	int i, j, k, temp;
	for (i = 1; i < n; i++)
	{
...
//14th
void InsertionSort14(int nums[], int n)
{
	int i, j, k, temp;
	for(i=1;i<n;i++)
	{
...
//15th
void InsertionSort15(int nums[], int n)
{
	int i, j, k, temp;
	for (i = 1; i < n; i++)
	{
...
//16th
void InsertionSort16(int nums[], int n)
{
	int i, j, k, temp;
	for (i = 1; i < n; i++)
	{
...
//17th
void InsertionSort17(int nums[], int n)
{
	int i, j, k, temp;
	for (i = 1; i < n; i++)
	{
...
//18th
void InsertionSort18(int nums[], int n)
{
	int i, j, k, temp;
	for (i = 1; i < n; i++)
	{
...
//19th
void InsertionSort19(int nums[], int n)
{
	int i, j, k,temp;
	for (i = 1; i < n; i++)
	{
