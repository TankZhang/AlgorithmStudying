...
//11th
void BubbleSort2_11(int nums[], int n)
{
	int i, j;
	bool flag = true;
	for (i = 0; i < n&&flag; i++)
...
//13th
void BubbleSort2_13(int nums[], int n)
{
	int i, j;
	bool flag = true;
	for(i=0;i<n&&flag;i++)
...
//14th
void BubbleSort2_14(int nums[], int n)
{
	int i, j;
	bool flag = true;
	for (i = 0; i < n&&flag; i++) 
...
//15th
void BubbleSort2_15(int nums[], int n)
{
	bool flag = true;
	int i, j;
	for (i = 0; i < n&&flag; i++)
...
//16th
void BubbleSort2_16(int nums[], int n) 
{
	bool flag = true;
	int i, j;
	for (i = 0; i < n&&flag; i++) {
...
//17th
void BubbleSort2_17(int nums[], int n)
{
	bool flag = true;
	int i, j;
